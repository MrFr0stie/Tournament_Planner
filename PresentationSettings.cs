...
public static class UiLocalizer
{
    private static readonly Dictionary<string, string> EnglishToGerman = new()
    {
        ...
        ["New competition"] = "Neuer Wettbewerb", ["Import tournament"] = "Turnier importieren", ["Export tournament"] = "Turnier exportieren", ["Withdraw selected"] = "Ausgewählten Spieler abmelden", ["Show archived"] = "Archivierte anzeigen", ["Archive"] = "Archivieren", ["Restore"] = "Wiederherstellen", ["Delete"] = "Löschen", ["ACTIVE COMPETITION"] = "AKTUELLER WETTBEWERB", ["Enter results"] = "Ergebnisse eintragen", ["Table"] = "Tabelle",
    ...
    private static void TranslateElement(DependencyObject element, bool german)
    {
        ...
        if (element is ContentControl { Content: string content } control) control.Content = Translate(content, german);
