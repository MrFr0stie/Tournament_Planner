...
public static class UiLocalizer
{
    private static readonly Dictionary<string, string> EnglishToGerman = new()
    {
        ...
        ["New competition"] = "Neuer Wettbewerb", ["Import tournament"] = "Turnier importieren", ["Export tournament"] = "Turnier exportieren", ["ACTIVE COMPETITION"] = "AKTUELLER WETTBEWERB", ["Enter results"] = "Ergebnisse eintragen", ["Table"] = "Tabelle",
